	...
	return (
		<main className="py-24 bg-gray-300">
			<section className="min-h-[calc(100vh-80px)]">
				...
				<section className="bg-gradient-to-r from-cyan-500 to-cyan-900 p-10 lg:p-24 text-slate-300 font-bold text-xl lg:text-2xl mt-5">
					<h2 className="lg:w-4/5 mx-auto">
						...
						su empresa una brillante oportunidad para complementar e incorporar
						conceptos esenciales y actualizados, que amplíen y profundicen su
						conocimiento, ya que sabemos la importancia de tener un personal
						integrado.
					</h2>
				</section>
			</section>
				...
				<div className="container px-6 py-5 mx-auto">
					<div className="grid grid-cols-1 gap-8 my-5 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
						<div className="p-8 space-y-3 border-2 border-cyan-500  rounded-xl">
							...
							<p className="text-gray-500 leading-7 lg:text-xl">
								...
								nos enseñan que para evolucionar necesitamos emprender un nuevo
								camino con una forma diferente de ser y actuar.
							</p>
						</div>
						...
						<div className="p-8 space-y-3 border-2 border-cyan-500  rounded-xl">
							...
							<p className="text-gray-500 leading-7 lg:text-xl">
								...
								herramienta indispensable que permite interactuar en tiempo real
								con los profesores.
							</p>
						</div>
			...
			<section className="my-5 container mx-auto px-6">
				...
				<h2 className="text-xl font-semibold pt-5">Nuestro temario incluye:</h2>
				<ul className="space-y-3 mt-4">
					<li className="flex items-center gap-2 font-medium">
						<AiOutlineCheckCircle size={25} color="#0A9AB6" />
			...
			<section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 my-10">
				...
				<p className="text-slate-500 text-lg text-center mb-5">
				...
				<div className="grid grid-cols-1 gap-8 my-5 xl:gap-12 md:grid-cols-2">
					<div className="p-8 space-y-3 border-2 border-cyan-500 rounded-xl">
						...
						<p className="text-gray-500 leading-7 lg:text-xl">
							...
							es producto del grupo humano que lo forma por lo que creamos un
							espacio virtual que ayude a que los conocimientos nos sirvan de
							por vida.
						</p>
					</div>
					...
					<div className="p-8 space-y-3 border-2 border-cyan-500  rounded-xl">
						...
						<p className="text-gray-500 leading-7 lg:text-xl">
							...
							instrucción exhaustiva y a la medida que usted necesita.
						</p>
					</div>
				</div>
			</section>
